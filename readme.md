...
#### Cluster Analyse
Wenn man nun auf Cluster klickt, kann man den gewünschten Cluster auswählen. Dort wird dann eine Reihe an Information angezeigt, um die Auslastung des Cluster näher betrachten zu können. Es wird die aktuelle CPU Auslastung angezeigt, aber auch wie viel CPU Requests im gesamten Cluster angefordert werden und welches CPU Limits im gesamten Cluster definiert sind.  Dasselbe sieht man auch für die Arbeitsspeicherauslastung. Außerdem kann man sehen wie viele Pods aktuell tatsächlich laufen und wie viele verfügbar wären. Der Netzwerk-Traffic ist ebenfalls über ein Diagramm ersichtlich. Außerdem hat man eine schnelle Übersicht ob alle Nodes bereit sind, ob es Nodes mit Warnungen gibt und ob es Nodes mit Problemen gibt. Auch über die Workloads hat man auf einem Blick eine schnelle Übersicht der wichtigsten Informationen. Man sieht ob es Workloads gibt mit Container die gerade neu starten, ob es Workloads gibt mit fehlgeschlagenen Pods etc.
...
#### Nodes Analyse
So kann man sich wenn man auf einen Node klickt ebenfalls die CPU und Arbeistsspeicherauslastung anzeigen lassen. Es ist genau aufgelistet wie viele Pods sich in dem Node befinden und wie viele Container darin laufen. Auch Probleme und Vulnerabilities würden angezeigt werden wenn es welche gibt. Über den Reiter Utilization kann man auch hier wieder den Netzwerk-Traffic sehen. Die laufenden Pods in dem ausgewählten Nodes können über eine Liste eingesehen werden. Die Übersicht über CPU Auslastung etc. sieht ähnlich aus wie auf der Clusterübersicht. In dem Standard Cluster Monitoring kann man auch noch Diagramme im Reiter Logs und Events sehen (siehe nachfolgender Screenshot)
